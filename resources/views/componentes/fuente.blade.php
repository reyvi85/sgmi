...
<div class="card">
    <div class="card-header"><h5><i class="fas fa-list"></i> Fuente
                ...
                <table class="table table-striped">
                    ...
                    @foreach($lista as $row)
                        <tr>
                            ...
                            <td class="text-right">
                                <form action="{{route('fuente.destroy', $row->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('fuente.store', $computadora->id)}}" method="post">
                        @csrf
            ...
            <div class="modal fade" id="EDIT-{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="EDIT-CD-{{$row->id}}" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('fuente.update', $row->id)}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="validationDefault01">Numero de Serie:</label>
