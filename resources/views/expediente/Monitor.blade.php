@if ($modeMin == false)
    <div class="py-2">
        <div class="card">
            ...
            <div class="card-body">
                @if (count($computadora->monitors) == 0)
                ...
                @else
                    <div class="table-responsive">
                        <table class="table table-sm">
                            ...
                            <tbody>
                            @foreach($computadora->monitors as $row)
                                <tr>
                                    ...
                                    <td class="text-center">{{$row->nm_monitor->name}}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
    ...
    @else
        @foreach($computadora->monitors as $row)
            ...
            <strong>TIPO: </strong> {{$row->nm_monitor->name}}<br>
            <hr>
        @endforeach
    @endif
@endif
